...
document.getElementById("practice_create_room").addEventListener("click", function() {
	startSolo(soloSelectedSize);
});

// Solo info card buttons (visible inside the game view when soloSession is active).
