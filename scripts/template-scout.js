...
// analyzeWithTracking now decides solvability with the sound CSPSolver, so case-only boards score
...
function storePuzzles(out, id, t){
	...
	for(const rec of out.tops){
		...
		const a = PG.analyzeWithTracking(board, revealed, mines.length);
